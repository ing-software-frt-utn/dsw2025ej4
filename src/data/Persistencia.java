...
public class Persistencia {
    ...
    /*private static void inicializarAnimales() throws InvalidPropertiesFormatException {
        animales.add(new Carnivoro(5,250,paises.get(0), especieSeleccionada, sectores.get(1)));
        animales.add(new Carnivoro(2,180,paises.get(2), especieSeleccionada, sectores.get(3)));
