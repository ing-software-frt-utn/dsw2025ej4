...
public class Carnivoro extends Mamifero {
    ...
    public Carnivoro(int edad, double peso, Pais pais, Especie especie, Sector sector) throws InvalidPropertiesFormatException {
        super(TipoAlimentacion.CARNIVORO, pais, edad, peso, especie, sector);
    } 
