...
public class Herbivoro extends Mamifero{
    ...
    public Herbivoro(int edad, double peso, Pais pais, Especie especie, Sector sector, double valorFijo) throws InvalidPropertiesFormatException {
        super(TipoAlimentacion.HERBIVORO, pais, edad, peso, especie, sector);
